  ...
  <table width="100%" border="1" bordercolor="#999999" cellpadding="0" cellspacing="0" class="bodytable">
    ...
    <tr>
      ...
      <td align="left" valign="top"><div class="maincontent">
		...
		switch($q) {
			case "add" :include_once("includes/client_add.php"); break;
			case "edit" :include_once("includes/client_edit.php"); break;
			default:  include_once("includes/client_list.php"); break;
		}?>
        </div></td>
    </tr>
    <tr>
