...
function faculty_valid(){
	...
	if(frm.faculty_designation.value.length==0){
		document.getElementById('validation_div').innerHTML='Please Enter Designation.!';
		frm.faculty_designation.focus();
		frm.faculty_designation.style.borderColor='red';
		return false;
	}else{
		frm.faculty_designation.style.borderColor='';
	}
