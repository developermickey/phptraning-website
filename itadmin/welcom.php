...
<script type="text/javascript">
        ...
        function validate()
        {
            if(document.form1.videotitle.value=="")
            {
                alert("Please Enter Video Title");
                document.form1.videotitle.focus();
                return false;	
            }
           
            if(document.form1.videolink.value=="")
            {
                alert("Please Enter Video Link");
                document.form1.videolink.focus();
                return false;	
            }
        }
    </script>   
  ...
  <table width="100%" border="1" bordercolor="#999999" cellpadding="0" cellspacing="0" class="bodytable">
    ...
    <tr>
      ...
      <td align="left" valign="top"><div class="maincontent">
		...
		switch($q) {
			case "add" :include_once("includes/welcom_add.php"); break;
			case "edit" :include_once("includes/welcom_edit.php"); break;
			default:  include_once("includes/welcom_list.php"); break;
		}?>
        </div></td>
    </tr>
    <tr>
