...
<div class="content_header">
  <div class="heading flleft">News</div>
  <div class="heading flright"><a href="news.php?q=add">Add New News</a></div>
...
?>
    <tr>
	  ...
	  <input type="checkbox" name="new" onclick="chkboxLN(this)" value="<?=$id?>" <?php if($new==1) echo 'checked="checked"';?>/>
	  <span id="newBlink<?=$id?>">
