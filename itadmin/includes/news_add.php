...
<div class="content_header">
  <div class="heading flleft">Add New News</div>
    ...
    <div id="validation_div" class="validation_error" align="center"></div>
      <table width="100%" border="0" cellspacing="0" cellpadding="3" align="center">
        ...
        <tr>
          ...
          <td>
		  <textarea name="title" style="width:99%;height: 50px;"  id="title" onblur="fillURL(this.value,'url')"></textarea>
		  </td>
        </tr>
		...
		<input class="two" type="text" name="publish_date" value="" readonly=""/>
         ...
         <tr>
		  ...
		  <div id="desc">
		   <b>URL <?=$required?></b><br />
		  <input type="text" name="url" id="url" value="<?=$res['oDATA'][0]['url'];?>" size="70" maxlength="20"/>
