...
$res = $eventsObj->getEventsById($id); 
...
<div class="content_header">
  <div class="heading flleft">Update Events</div>
  <div class="heading flright"><a href="<?=$_curpage?>">&laquo; Back</a></div>
</div>
<div class="bodycontent">
  <form name="frmnotice" action="EventsAction.php" method="post" onsubmit="return happenings_valid()" enctype="multipart/form-data">
    ...
    <div id="validation_div" class="validation_error" align="center"></div>
      <table width="100%" border="0" cellspacing="0" cellpadding="3" align="center">
		...
		<div id="file" <?=$display1?>>
			...
			<?php if($res['oDATA'][0]['file_name']) {?><a href="../events/<?=outText($res['oDATA'][0]['file_name']);?>" target="_blank">view</a><?php }?>
