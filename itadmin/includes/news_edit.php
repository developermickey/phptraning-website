...
<div class="content_header">
  <div class="heading flleft">Update News</div>
  <div class="heading flright"><a href="<?=$_curpage?>">&laquo; Back</a></div>
</div>
<div class="bodycontent">
  <form name="frmnotice" action="NewsAction.php" method="post" onsubmit="return happenings_valid()" enctype="multipart/form-data">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="3" align="center">
        ...
        <tr>
         ...
         <tr>
		  ...
		  <font color="#990000"><i> URL in text format (Max 20 chars)</i></font><br />
		  <b>Description</b><br />
