...
/*function checkFacultyURL(facurl,act,id) {	
	if(facurl.value!="") {
		$.get("FacultyAjax.php?act="+act+"&furl="+facurl.value+"&id="+id, function(res){
			if(res !=0) {
  ...
  <table width="100%" border="1" bordercolor="#999999" cellpadding="0" cellspacing="0" class="bodytable">
    ...
    <tr>
      ...
      <td align="left" valign="top"><div class="maincontent">
		...
		switch($q) {
			case "add" :include_once("includes/faculty_add.php"); break;
			case "edit" :include_once("includes/faculty_edit.php"); break;
			default:  include_once("includes/faculties_list.php"); break;
		}?>
        </div></td>
    </tr>
    <tr>
