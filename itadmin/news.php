...
function sortdata(orderby) {
	document.location.href="NewsSort.php?orderby="+orderby;
} 
</script>
<script type="text/javascript">
...
<table width="100%" border="1" bordercolor="#999999" cellpadding="0" cellspacing="0" class="bodytable">
  ...
  <tr>
	...
	<div class="maincontent">
		...
		switch($q) {
			case "add" : {include_once("includes/news_add.php"); break;}
			case "edit" : {include_once("includes/news_edit.php"); break;}
			default:  {include_once("includes/news_list.php"); break;}
		}?>
    </div>
    </td>
  </tr>
