...
<script>
  ...
  <script>
  	function sum(){
	   ...
	   var txtEighthNumberValue = document.getElementById('txt8').value;
	   var txtNinthNumberValue = document.getElementById('txt9').value;
	   var txtTenthNumberValue = document.getElementById('txt10').value;
	   ...
	   if (txtTenthNumberValue == "")
           txtTenthNumberValue = 0;		      	   	   	      
       ...
       if (!isNaN(result)) {
           document.getElementById('txt11').value = result;
       }
   }
  ...
  <table width="100%" border="1" bordercolor="#999999" cellpadding="0" cellspacing="0" class="bodytable">
    ...
    <tr>
      ...
      <td align="left" valign="top"><div class="maincontent">
		...
		switch($q) {
			case "add" :include_once("includes/resultpg_add.php"); break;
			case "edit" :include_once("includes/resultpg_edit.php"); break;
			default:  include_once("includes/resultpg-list.php"); break;
		}?>
        </div></td>
    </tr>
    <tr>
