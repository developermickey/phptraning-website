...
function sortdata(orderby) {
	document.location.href="HunarSort.php?orderby="+orderby;
} 
</script>
</head>
<body> 
...
<table width="100%" border="1" bordercolor="#999999" cellpadding="0" cellspacing="0" class="bodytable">
  ...
  <tr>
	...
	<div class="maincontent">
		...
		switch($q) {
			case "add" : {include_once("includes/hunar_add.php"); break;}
			case "edit" : {include_once("includes/hunar_edit.php"); break;}
			default:  {include_once("includes/hunar_list.php"); break;}
		}?>
    </div>
    </td>
  </tr>
